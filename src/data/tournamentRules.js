  ...
  },
  {
    ...
    subsections: [
      ...
      },
      {
        ...
        content: [
          {
            text: "The start of game procedure happens in the following order:",
          },
          {
            text:
      ...
      },
      {
        ...
        content: [
          ...
          {
            text: "Pen and paper or other method to keep track of life totals",
            modifiers: "list",
          },
      ...
      },
      {
        ...
        content: [
          ...
          {
            text: "It’s suggested that players use the toilet between rounds.",
          },
        ],
      },
    ],
    ...
    subsections: [
      {
        ...
        content: [
          ...
          { text: "The amount of action points remaining", modifiers: "list" },
          {
    ...
    subsections: [
      ...
      },
      {
        ...
        content: [
          ...
          {
            text: "Failing to follow instructions from a tournament official.",
            modifiers: "list",
          },
    ...
    subsections: [
      {
        ...
        content: [
          ...
          {
            text: "Saying “Oh my goodness, I’m so lucky to open [CARD NAME].”",
            modifiers: "list",
          },
          {
