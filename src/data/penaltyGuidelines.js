const penaltyGuidelines = [
  {
    ...
    subsections: [
      ...
      },
      {
        ...
        content: [
          { text: "{i} intellect" },
          { text: "{r} resource point" },
          { text: "{h} life points" },
          { text: "{p} power" },
          { text: "{d} defense value" },
        ],
      },
    ],
  },
    ...
    subsections: [
      ...
      },
      {
        ...
        content: [
          ...
          { text: "IP Penalty", modifiers: "bold" },
    ...
    subsections: [
      {
        ...
        content: [
          ...
          {
            text: "Examples of where the trigger is not missed.",
            modifiers: "bold",
          },
          ...
          {
            text: "Examples of where the trigger is missed",
            modifiers: "bold",
          },
          {
            text:
          ...
          { text: "Detrimental Triggers", modifiers: "bold" },
          {
            text:
          ...
          { text: "Beneficial Triggers", modifiers: "example" },
          {
            text:
          ...
          {
            text: "A player hits with Snatch and forgets to draw a card.",
            modifiers: "example",
          },
          {
            text:
          ...
          {
            text: "Recommended penalty (Detrimental Trigger):",
            modifiers: "bold",
          },
          { text: "Casual - Warning" },
          {
          ...
          {
            text: "Recommended penalty (Beneficial Trigger):",
            modifiers: "bold",
          },
          { text: "Casual - Caution" },
          { text: "Professional - Caution" },
          { text: "Recommended Fix:", modifiers: "bold" },
          {
            text:
      ...
      },
      {
        ...
        content: [
          ...
          { text: "Recommended penalty", modifiers: "bold" },
          { text: "Casual - Caution" },
          { text: "Professional - Warning" },
          { text: "Casual and Professional fix", modifiers: "bold" },
          {
            text:
      ...
      },
      {
        ...
        content: [
          ...
          { text: "Recommended penalty", modifiers: "bold" },
          { text: "Casual – Warning" },
          { text: "Professional - Warning / IP2" },
          { text: "Casual/Professional fix", modifiers: "bold" },
          {
            text:
      ...
      },
      {
        ...
        content: [
          ...
          { text: "Casual – Warning" },
          { text: "Professional - Warning / IP2" },
          { text: "Casual fix", modifiers: "bold" },
          {
            text:
          ...
          { text: "Professional Fix", modifiers: "bold" },
          {
            text:
              "If it has been caught immediately, the game state is reversed to the time it was last legal and play continues. The player who committed the infraction is given a Warning.",
          },
    ...
    subsections: [
      {
        ...
        content: [
          ...
          {
            text: "A player plays a whole match with the incorrect opponent.",
            modifiers: "example",
          },
          {
            text:
          ...
          { text: "Recommended penalty", modifiers: "bold" },
          { text: "Casual", modifiers: "bold" },
          {
            text:
              "Best of 1 match - IP5 (3 mins after round timer starts), Match Loss (10 mins)",
          },
          {
            text: "Best of 3 match - Game Loss (3 mins), Match Loss (10 mins)",
          },
          { text: "Professional", modifiers: "bold" },
          {
            text:
              "Best of 1 match - IP5 (0 mins after round time starts), Match Loss (10 mins)",
          },
          {
            text: "Best of 3 match - Game Loss (0 mins), Match Loss (10 mins)",
          },
          { text: "Casual and Professional Fix", modifiers: "bold" },
          {
            text:
      ...
      },
      {
        ...
        content: [
          ...
          { text: "Recommended penalty", modifiers: "bold" },
          { text: "Casual – Game Loss" },
          { text: "Professional - Match Loss" },
          {
            text:
      ...
      },
      {
        ...
        content: [
          {
            text: "A player commits a procedural infringement during a draft.",
          },
          { text: "Examples (minor):", modifiers: "bold" },
          {
            text: "A player passes a pack the wrong way during the draft.",
            modifiers: "example",
          },
          {
            text:
          ...
          { text: "Examples (major):", modifiers: "bold" },
          {
            text:
          ...
          { text: "Examples (severe):", modifiers: "bold" },
          {
            text:
          ...
          { text: "Recommended penalty - minor", modifiers: "bold" },
          { text: "Casual – Caution" },
          { text: "Professional - Warning" },
          { text: "Recommended penalty - major", modifiers: "bold" },
          { text: "Casual – Warning" },
          { text: "Professional - IP2" },
          { text: "Recommended penalty - severe", modifiers: "bold" },
          { text: "Casual – Game Loss" },
          { text: "Professional - DQ" },
          {
            text:
      ...
      },
      {
        ...
        content: [
          ...
          {
            text: "Recommended penalty - minor (no pattern)",
            modifiers: "bold",
          },
          { text: "Casual – Caution" },
          { text: "Professional - Warning" },
          {
            text: "Recommended penalty - major (pattern)",
            modifiers: "bold",
          },
          { text: "Casual – Match Loss / DQ" },
          { text: "Professional - DQ" },
          {
            text:
      ...
      },
      {
        ...
        content: [
          ...
          { text: "Casual/Professional Fix", modifiers: "bold" },
          { text: "The deck is to be shuffled and penalties are issued." },
        ],
      },
      {
        number: "3.10",
        ...
        content: [
          ...
          { text: "Unsporting Conduct - Minor", modifiers: "bold" },
          {
            text:
          ...
          { text: "Examples:", modifiers: "bold" },
          {
            text: "A player uses mild-moderate offensive language.",
            modifiers: "example",
          },
          {
            text:
          ...
          {
            text: "A player does not pick up litter they have created.",
            modifiers: "example",
          },
          {
            text: "A player shoves other players while moving through crowds.",
            modifiers: "example",
          },
          {
            text:
          ...
          { text: "Casual – Warning" },
          { text: "Professional - Warning" },
          { text: "Unsporting Conduct - Major", modifiers: "bold" },
          {
            text:
          ...
          { text: "Examples:", modifiers: "bold" },
          {
            text: "A player makes a racial remark towards another person.",
            modifiers: "example",
          },
          {
            text: "A player uses intimidation tactics to get their way.",
            modifiers: "example",
          },
          {
            text: "A player harasses another person on social media.",
            modifiers: "example",
          },
          {
            text:
      ...
      },
      {
        ...
        content: [
          ...
          { text: "Examples:", modifiers: "bold" },
          {
            text: "A player offers their opponent cash to concede.",
            modifiers: "example",
          },
          {
            text:
      ...
      },
      {
        ...
        content: [
          ...
          {
            text: "A player throws their own or another person's belongings.",
            modifiers: "example",
          },
          {
            text:
          ...
          {
            text: "A player swears at their opponent during or after a match.",
            modifiers: "example",
          },
          { text: "Recommended penalty", modifiers: "bold" },
          { text: "Casual – Match Loss / DQ" },
          { text: "Professional - Match Loss / DQ" },
          {
            text:
      ...
      },
      {
        ...
        content: [
          ...
          {
            text: "A player steals tablecloths, or table numbers off a table.",
            modifiers: "example",
          },
          {
            text:
      ...
      },
      {
        ...
        content: [
          ...
          { text: "Recommended penalty", modifiers: "bold" },
          { text: "Casual – Match Loss next round / DQ" },
          { text: "Professional - Match Loss next round / DQ" },
        ],
      },
      {
        number: "3.19",
        ...
        content: [
          ...
          { text: "Rules Sharking - Minor", modifiers: "bold" },
          {
            text:
          ...
          { text: "Casual – Caution" },
          { text: "Professional - Caution" },
          { text: "Rules Sharking - Major", modifiers: "bold" },
          {
            text:
          ...
          { text: "Recommended penalty - major", modifiers: "bold" },
          { text: "Casual – Warning / DQ" },
          { text: "Professional - Warning / DQ" },
        ],
      },
    ],
  },
